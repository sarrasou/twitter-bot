...
# Insert your credentials into single quotes

pet_finder_url = 'https://api.petfinder.com/v2/animals?type=cat&location=Buffalo, NY&status=adoptable&distance=20&sort=recent'
